...
class PowertrainEnv_powerflow(gym.Env):
    """
    ...
    def __init__(self, component_library, component_class, component_type, opt_method="test", render_mode="human", random_dsm=1, init_dsm=None):
        super(PowertrainEnv_powerflow, self).__init__()
    ...
    def step(self, action):
        ...
        is_feasible = check_feasibility(sorted_used_powerflow)
